        ...
        <div id={"about_rooms"}>
            ...
            <div className={"container"}>
                ...
                <div className={"row col-md-12 mt-5"}>
                    <div className={"col-md-5"}>
                        <div className={"d-flex align-items-center justify-content-center"}>
                            <img src={restaurant} className={"me-2 m-0"} style={{width:"40%", height:"30vh"}} alt=""/>
                            <img src={restaurant1} className={"me-2"}  style={{width:"40%",  height:"30vh"}} alt=""/>
                        </div>
                    </div>
                    <div className={"col-md-7"}>
                ...
                <div className="row col-md-12 mt-5">
                    ...
                    <div className={"col-md-5"}>
                        <div className={"d-flex align-items-center justify-content-center"}>
                            ...
                            <img src={receptions1} className={"me-2"} style={{width:"35%",  height:"30vh"}} alt=""/>
                        </div>
                    </div>
                </div>
                ...
                <div className={"row col-md-12 mt-5"}>
                    ...
                    <div className={"col-md-5"}>
                        <div className={"d-flex align-items-center justify-content-center"}>
                            ...
                            <img src={garden2} className={"me-2 m-0"} style={{width:"35%", height:"28vh"}} alt=""/>
                        </div>
                    </div>
                </div>
