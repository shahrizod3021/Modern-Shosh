                ...
                <div className={"container"}>
                    ...
                    <div className={"row col-md-12 mb-5"}>
                        ...
                        <div className={"col-md-7"}>
                            ...
                            <p className={"text-white p-pas playfair"}>
                                {localStorage.getItem("lang") === "uzb" ? "Double Deluxe-dagi asosiy joylar soni: 2. Bepul Wi-Fi va telefon. Elektronika: konditsioner, televizor va muzlatgich. Qulayliklar: rasmlar, anatomic matraslar, qo'shimcha matras (sizning so'rovingiz bo'yicha). Dush barcha zarur bir martalik gigiena vositalari bilan. Xonaning maydoni 30 kv. m. Mebel: stol, stul, oyna va divan. Ochiq ko'ngilochar maydon, shahar manzarasi. Oziq-ovqat va ichimliklar, ichimlik suvi, choy va shakar. Vannada dush, yuz sochiqlari, shuningdek oyoq sochiqlari, bir martalik gigiena vositalari, oyna, dazmol va kim ilgich mavjud." : localStorage.getItem("lang") === "rus" ? "Количество основных мест в Double Deluxe: 2. Бесплатный Wi-Fi и телефон. Электроника: кондиционер, телевизор и холодильник. Удобства: картины, анатомические матрасы, дополнительный матрас (по Вашему запросу). Душевая кабина со всеми необходимыми одноразовыми гигиеническими средствами. Площадь номера - 30 кв.м. Мебель: стол, стул, зеркало и диван. Открытая развлекательная зона, вид на город. Еда и напитки, питьевая вода, чай и сахар. В ванной комнате имеется душевая кабина, полотенца для лица, а также полотенца для ног, одноразовые средства гигиены, зеркало, утюг и вешалка для одежды."
                                    : "Number of main beds in Double Deluxe: 2. Free Wi-Fi and telephone. Electronics: air conditioning, TV and refrigerator. Amenities: paintings, anatomical mattresses, additional mattress (upon your request). Room area - 30 sq.m. Furniture: table, chair, mirror and sofa. Outdoor entertainment area, city views. Food and drinks, drinking water, tea and sugar. The bathroom has a shower cabin, a face towel and a foot towel, all necessary disposable hygiene products, a mirror, an iron and a clothes hanger."}
                            </p>
                        </div>
                        ...
                        <div className={"col-md-7"}>
                            ...
                            <p className={"text-white p-pas playfair me-3"}>
                                {localStorage.getItem("lang") === "uzb" ? "Uchlik xonasida  asosiy joylar soni: 3 ta. Internet va telefoniya , bepul Wi-Fi, telefon, elektronik konditsioner mavjud. Qulayliklar : rasmlar, muzlatgich, anatomik matraslar, qo'shimcha matras (sizning so'rovingiz bo'yicha). Xona kattaligi - 25 kv.m . Mebel, stol, stul, oyna, karavot yonidagi stoli bilan . Ko'ngil ochar  TV, tashqi hudud, shahar manzarasi sizga manzur , oziq-ovqat va ichimliklar, ichimlik suvi, choy va shakar ham bor. Kiyim parvarishlash uchun shkaf, ilgichlar bor . Zamonaviy va  qulay mebel va panoramali derazalar bilan jihozlangan ushbu yorug' xonaning derazasi go'zal shaharni ko'rsatib turadi."
                                    : localStorage.getItem("lang") === "rus" ? "Трехместный номер - количество основных мест: 3. Бесплатный Wi-Fi и телефон. Электроника: кондиционер, холодильник. Удобства: картины, анатомические матрасы, дополнительный матрас (по Вашему запросу). Душевая кабина со всеми необходимыми одноразовыми гигиеническими средствами. Площадь номера 25 кв.м. Мебель: стол, стул, зеркало и тумбочка. В ванной комнате имеется душевая кабина, полотенца для лица и ног, одноразовые средства гигиены, вешалки для одежды."
                    ...
                    <div className={"row col-md-12 mt-5"}>
                        ...
                        <div className={"col-md-7"}>
                            ...
                            <p className={"text-white p-pas playfair"}>
                                {localStorage.getItem("lang") === "uzb" ? "Hashamatli va shinam restoran - bu tashrif buyuruvchilar mazali taomlardan bahramand bo'lishlari mumkin bo'lgan joydir. Va devor o'simliklari restoranni o'ziga xos hid bilan to'ldiradi va shu bilan tashrif buyuruvchilarning qulay yashashi uchun maxsus muhit yaratadi. Har kuni soat 7:00 dan 10:00 gacha hashamatli restoranimizda nafis va mazali nonushta qilishingiz mumkin. Siz bizning hashamatli restoranimizda mazali nonushta qilishingiz mumkin. Tabassumli va muloyim hodimlarimiz doimo sizga yordam berishga va barcha savollaringizga javob berishga tayyor."
