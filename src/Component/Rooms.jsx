                ...
                <div className={"container"}>
                    <div className={"row col-md-12 mb-5"}>
                        <div className={"col-md-7"}>
                            ...
                            <p className={"text-white p-pas playfair playfair"}>
                                {localStorage.getItem("lang") === "uzb" ? "Oilaviy xonasi - asosiy joylar soni: 3 ta. Internet va telefoniya ,bepul Wi-Fi va telefon. Elektronika - konditsioner va xolodilnik mavjud. Qulayliklar , rasmlar , anatomik matraslar , qo'shimcha matras (sizning so'rovingiz bo'yicha) , xona maydoni - 25 kv.m . Kiyimlarni parvarish qilish uchun - shkaf , ilmoqlar mavjud . Bir kishilik va yagona turdagi  karavoti mavjud  qulay xona. Xonada qulay zamonaviy mebellar, shuningdek stol bilan tashkil etilgan ish joyi mavjud." : localStorage.getItem("lang") === "rus" ? "Family room - количество основных мест: 3. Интернет и телефония , бесплатный Wi-Fi , телефон. Электроника ,кондиционер ,холодильник. Удобства ,картины ,анатомические матрасы , дополнительный матрас (по вашему запросу) , площадь номера- 25 кв.м , унитаз , урно. Уход за одеждой , шкаф , вешалки. Комфортабельный номер с одной двуспальной и одной односпальной кроватями. В номере удобная современная мебель, а также организованное рабочее пространство с письменным столом." : "Family Dream - number of main beds : 3. Internet and telephony , free Wi-Fi ,telephone. Electronic  air conditioning , refrigerator . Amenities  : pictures , anatomical mattresses , extra mattress (at your request) , Room area is 25 sq.m. Clothes care - wardrobe - hangers. Comfortable room with one single bed and one person bed. The room has comfortable modern furniture, as well as an organized work area with a desk. This room is ideal for families with children who likes to sleep with their parents and where they can stay comfortably and without unnecessary stress."}
                            </p>
                        </div>
                        ...
                        <div className={"col-md-7"}>
                            ...
                            <p className={"text-white p-pas playfair"}>
                                {localStorage.getItem("lang") === "uzb" ? "Lyuks xona - asosiy karavotlar soni: 2 ta, bepul Wi-Fi uchun internet va telefoniya . Elektron konditsioner, rasmlar, muzlatgich, anatomik matraslar, qo'shimcha matras (sizning so'rovingiz bo'yicha), xona kattaligi - 30 kv.m . Mebel, stol, stul, oyna, divan, televizor. Ochiq ko'ngilochar zona va  shaharning ajoyib  ko'rinishi. Oziq-ovqat va ichimlik, ichimlik suvi, choy va shakar mavjud. Hammomda dush, yuz va oyoq sochiqlari, bir martalik gigiena vositalari, oyna, dazmol, kiyim ilgichi mavjud." : localStorage.getItem("lang") === "rus" ? "Количество основных мест в Double Deluxe: 2, Интернет и телефония бесплатно Wi-Fi Телефон Электронный кондиционер, картины, холодильник, анатомические матрасы, дополнительный матрас (по вашему желанию), площадь номера - 30 кв.м. Мебель, стол, стул, зеркало, диван, телевизор. Открытая развлекательная зона, вид на город. Еда и напитки, питьевая вода, чай и сахар. В ванной комнате имеется душевая кабина, полотенца для лица, а также полотенца для ног, одноразовые средства гигиены, зеркало, утюг, вешалка для одежды."
                                    : "Number of basic beds in Double Deluxe: 2, Internet and telephony for free Wi-Fi ,  telephone electronic air conditioning, paintings, refrigerator, anatomical mattresses, extra mattress (at your request), room size - 30 sq.m. Furniture, table, chair, mirror, sofa, TV. Outdoor entertainment area, city view from window. Food and drink, drinking water, tea and sugar. The bathroom has a shower, face and foot towels, disposable hygiene products, mirror, iron, clothes hanger."}
                            </p>
                        </div>
                    ...
                    <div className="row col-md-12 mt-5">
                        <div className={"col-md-7"}>
                            ...
                            <p className={"text-white p-pas playfair playfair"}>
                                {localStorage.getItem("lang") === "uzb" ? "Bir kishilik  xonada asosiy o'rinlar soni: 2 ta Internet va telefoniya, bepul Wi-Fi, telefon, Elektron konditsioner, muzlatgich mavjud. Qulayliklar: rasmlari, anatomik matraslar, xona maydoni - 12 kv.m. Mebel stol stul oynasi bilan va karavotlar bor . Ko'ngilochar Tashqi hudud, shahar manzarasi ko'rinib turadi. Oziq-ovqat va ichimlik suvi, choy va shakar bor. Hammom da dush kabinasi, hammom, yuz va oyoq sochiqlari , bir marta ishlatiladigan gigiena vositalari bor, Kiyimlarni parvarish qilish uchun shkaf ilgichlari mavjud."
                                    : localStorage.getItem("lang") === "rus" ?
                                        ...
                                        : "Number of main beds in a single room: 2 Internet and telephony, free Wi-Fi, telephone, electronic air conditioner, refrigerator. Amenities: pictures, anatomical mattresses, room area - 12 sq.m. Furniture table with chair window and bed, Entertainment Outside area, city view from window. Food and drinking water, tea and sugar. The bathroom has a shower cabin, bath, face and foot towels, disposable hygiene products, for clothes care : closet hangers."}</p>
                        </div>
                        <div className={"col-md-5"}>
                            <div className={"d-flex align-items-center justify-content-center"}>
                    ...
                    <div className={"row col-md-12 mt-5"}>
                        ...
                        <div className={"col-md-7 "}>
                            ...
                            <p className={"text-white p-pas playfair"}>
                                {localStorage.getItem("lang") === "uzb" ? "Egizak xonada asosiy karavotlar soni: 2 ta , Internet va telefoniya, bepul Wi-Fi va telefon, Elektron konditsioner mavjud . Qulayliklar : rasmlari, xolodilnik, anatomik matraslar, qo'shimcha matras (sizning so'rovingiz bo'yicha). Xona hajmi 20 kv.m . Mebel stol stul oynasi bilan, karavot, ko'ngilochar televidenie, tashqi hudud va shahar ko'rinishi sizga manzur. Oziq-ovqat va ichimlik suvi, choy va shakar ham bor. Hammom da dush kabinasi, yuz va oyoq sochiqlari, bir marta ishlatiladigan gigiena vositalari kiyimlarni parvarish qilish shkafi ilgichlari mavjud."
                                    : localStorage.getItem("lang") === "rus" ? "Количество основных кроватей в двухместном номере: 2, Интернет и телефония, бесплатный телефон Wi-Fi, электронный кондиционер. В номере: картины, холодильник, анатомические матрасы, дополнительный матрас (по вашему желанию), площадь номера 20 кв.м. Мебель, стол, стул с зеркалом, кровать, развлекательный телевизор, открытая площадка и вид на город. Еда и питьевая вода, чай и сахар. В ванной комнате имеется душевая кабина, полотенца для лица и ног, одноразовые средства гигиены, вешалки для одежды."
                                        : "Number of main beds in twin room: 2, Internet and telephony, free Wi-Fi phone, electronic air conditioner. Amenities: pictures, refrigerator, anatomical mattresses, extra mattress (at your request), room size 20 sq.m. Furniture table chair with mirror, bed, entertainment TV, outdoor area and city view. Food and drinking water, tea and sugar. The bathroom has a shower cabine, face and foot towels, disposable hygiene products, clothes hangers."}
                            </p>
                        </div>
                    </div>
                    <div className="row col-md-12 mt-5">
                        <div className={"col-md-7"}>
                            ...
                            <p className={"text-white p-pas playfair me-3"}>
                                {localStorage.getItem("lang") === "uzb" ? "Uchlik xonasida  asosiy joylar soni: 3 ta. Internet va telefoniya , bepul Wi-Fi, telefon, elektronik konditsioner mavjud. Qulayliklar : rasmlar, muzlatgich, anatomik matraslar, qo'shimcha matras (sizning so'rovingiz bo'yicha). Xona kattaligi - 25 kv.m . Mebel, stol, stul, oyna, karavot yonidagi stoli bilan . Ko'ngil ochar  TV, tashqi hudud, shahar manzarasi sizga manzur , oziq-ovqat va ichimliklar, ichimlik suvi, choy va shakar ham bor. Kiyim parvarishlash uchun shkaf, ilgichlar bor . Zamonaviy va  qulay mebel va panoramali derazalar bilan jihozlangan ushbu yorug' xonaning derazasi go'zal shaharni ko'rsatib turadi."
                    ...
                    <div className={"row col-md-12 mt-5"}>
                        ...
                        <div className={"col-md-7"}>
                            ...
                            <p className={"text-white p-pas playfair"}>
                                {localStorage.getItem("lang") === "uzb" ? "Hashamatli va shinam restoran - bu tashrif buyuruvchilar mazali taomlardan bahramand bo'lishlari mumkin bo'lgan joydir. Va devor o'simliklari restoranni o'ziga xos hid bilan to'ldiradi va shu bilan tashrif buyuruvchilarning qulay yashashi uchun maxsus muhit yaratadi. Har kuni soat 7:00 dan 10:00 gacha hashamatli restoranimizda nafis va mazali nonushta qilishingiz mumkin.Ziyofatda har doim tabassumli va muloyim hodimlar bor, ular doimo sizga yordam berishdan va barcha savollaringizga javob berishdan mamnun."
                                    : localStorage.getItem("lang") === "rus" ? "Роскошный и уютный ресторан – это место, где посетители могут насладиться вкусной едой. А настенные растения наполняют ресторан неповторимым ароматом, тем самым создавая особую атмосферу для комфортного пребывания посетителей.  Каждый день с 7:00 до 10:00 вы сможете насладиться изысканным и вкусным завтраком в нашем роскошном ресторане."
                                        : "A luxurious and cozy restaurant is a place where visitors can enjoy with delicious food. And wall plants fill the restaurant with a unique aroma, thereby creating a special atmosphere for a comfortable to stay of visitors. Every day from 7:00 to 10:00 you can enjoy an exquisite and delicious breakfast in our luxurious restaurant."}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className={"row col-md-12 mt-5"}>
                        ...
                        <div className={"col-md-7"}>
                            ...
                            <p className={"text-white playfair me-3 p-pas"}>
                                {localStorage.getItem("lang") === "uzb" ? "Turli tadbirlar uchun mo'ljallangan keng va qulay xona. O'zining shkafi bilan jihozlangan zal 50 kishigacha sig'dira oldign  va konferentsiyalar uchun mo'ljallngan, seminarlar, taqdimotlar va boshqa ish uchrashuvlari uchun barcha zarur jihozlar: proyektor, ekran, audio va video jihozlar, mikrofonlar, interfaol doska bilan jihozlangan."
                ...
                <div className={"container room1"}>
                    <div className={"col-12 "}>
                        ...
                        <div className={"col-12 mt-3"}>
                            <h3 className={"text-white text-center mb-4"}>{localStorage.getItem("lang") === "uzb" ? "Oylaviy" : localStorage.getItem("lang") === "rus" ? "Cемейный" : "Family"}</h3>
                            <p className={"text-white p-pas playfair"}>
                                {localStorage.getItem("lang") === "uzb" ? "Oilaviy xonasi - asosiy joylar soni: 3 ta. Internet va telefoniya, bepul Wi-Fi va telefon. Elektronika - konditsioner va xolodilnik mavjud. Qulayliklar , rasmlar , anatomik matraslar, qo'shimcha matras (sizning so'rovingiz bo'yicha),  xona maydoni - 25 kv.m . Kiyimlarni parvarish qilish uchun - shkaf , ilmoqlar mavjud . Bir kishilik va yagona turdagi  karavoti mavjud  qulay xona. Xonada qulay zamonaviy mebellar, shuningdek stol bilan tashkil etilgan ish joyi mavjud." : localStorage.getItem("lang") === "rus" ? "Family room - количество основных мест: 3. Интернет и телефония , бесплатный Wi-Fi , телефон. Электроника ,кондиционер ,холодильник. Удобства ,картины ,анатомические матрасы , дополнительный матрас (по вашему запросу) , площадь номера- 25 кв.м , унитаз , урно. Уход за одеждой , шкаф , вешалки. Комфортабельный номер с одной двуспальной и одной односпальной кроватями. В номере удобная современная мебель, а также организованное рабочее пространство с письменным столом." : "Family Dream - number of main beds : 3. Internet and telephony , free Wi-Fi ,telephone. Electronic  air conditioning , refrigerator . Amenities  : pictures , anatomical mattresses , extra mattress (at your request) , Room area is 25 sq.m. Clothes care - wardrobe - hangers. Comfortable room with one single bed and one person bed. The room has comfortable modern furniture, as well as an organized work area with a desk. This room is ideal for families with children who likes to sleep with their parents and where they can stay comfortably and without unnecessary stress."}
                            </p>
                        </div>
