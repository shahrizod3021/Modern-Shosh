...
export const Gallarey = () => {
    ...
    return (
        <div id={"about"}>
            ...
            <div className={"why-we container"}>
                <h5 className={"text-white playfair"}
                    style={{marginBottom: "100px"}}>{localStorage.getItem("lang") === "uzb" ? "Bu 50 kishigacha sig'ishi mumkin. Mehmonxonada barcha toifadagi 43 ta qulay va oqlangan xona mavjud. Bizda bitta, egizak, uchlik, oilaviy va lyuks bor. Har bir xonada: mehmonxona bo'ylab ishlaydigan bepul Wi-Fi, telefon, konditsioner, muzlatgich, anatomik matraslar, qulay ishlash uchun stol va stul, ko'zgular, choyshablar va lampalar, ilgichli shkaf, choy to'plami, hammom, sochlarini fen mashinasi, sochiqlar va bir martalik gigiena vositalari. Hashamatli va shinam restoran tashrif buyuruvchilar mazali taomlardan bahramand bo'lishlari mumkin bo'lgan joy. Va devor o'simliklari restoranni o'ziga xos xushbo'y hid bilan to'ldiradi va shu bilan tashrif buyuruvchilar uchun qulay yashash uchun maxsus muhit yaratadi.\n"
