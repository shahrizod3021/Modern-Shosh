            ...
            <div className={"desktop-footer footer"}>
                ...
                <div className={"col-6 d-flex"}>
                    <div className={"d-flex flex-column col-6"}>
                        <div>
                            <h5 className={"text-white "}>Modern Shosh</h5>
                        </div>
                    ...
                    <div className={"col-6 "}>
                        <h6 className={"text-white mb-2"}>{localStorage.getItem("lang") === "uzb" ? <><a className={"mb-0 text-white"} href="mailto: info@modernshosh.uz">Email pochta: info@modernshosh.uz</a></> : localStorage.getItem("lang") === "rus" ? <>
                            <a className={"text-white"} href="mailto: info@modernshosh.uz">Электронная почта: info@modernshosh.uz</a></> : <>
                            <a className={"text-white"} href="mailto: info@modernshosh.uz">Email Address: info@modernshsoh.uz</a></>}</h6>
                        <h6 className={"text-white"}>{localStorage.getItem("lang") === "uzb" ?  <>
                            <a className={"text-white"} href="tel: +998951464004">Telefon raqam: +998951464004</a></>  : localStorage.getItem("lang") === "rus" ? <>
                            <a className={"text-white"} href="tel: +998951464004">Номер телефона: +998951464004</a></> :  <>
                            <a className={"text-white"} href="tel: +998951464004">Phone number: +998951464004</a></> }</h6>
                    </div>
                </div>
                <div className={"col-3"}>
                    <a href="#home"><img src={logo} alt="topilmadi" className={"footer-img"}/></a>
