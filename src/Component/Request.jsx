        ...
        <div id={"contact"}>
            <div className={"container mb-5"}>
                <div className={"row col-xl-12"}>
                    <div className={"col-xl-5 shadow-lg me-md-5 h-auto"} style={{padding:"20px", borderRadius:"20px"}}>
                        ...
                        <form >
                            <label htmlFor="name" className={"text-white mt-4 mb-2"}>{localStorage.getItem("lang") === "uzb" ? "Ismingiz" : localStorage.getItem("lang") === "rus" ? "Ваше имя" : "Your name"}</label>
                            ...
                            <input type="text" value={phoneNumber} onChange={e => setPhoneNumber(e.target.value)}   placeholder={"+998 (_) ___ __ __"}  style={{backgroundColor:"#333"}} id={"phoneNumber"} name={"phoneNumber"} className={"text-white form-control-lg w-100  mb-3 border-0"}/>
                        ...
                        <div className={"d-flex flex-column"}>
                            ...
                            <div className={"maps mb-2"}>
                                <iframe
                                    ...
                                    width="300px" height="150px" frameBorder="0"></iframe>
                                <div className={"d-flex flex-column"}>
                            ...
                            <div className={"maps "}>
                                <div id={'gis'}><a target={"_blank"} href="https://2gis.uz/tashkent/firm/70000001061261679?m=69.314119%2C41.333114%2F17.4"><img src={gis}  width={"300px"} height={"150px"} className={"me-5"} alt=""/></a> </div>
                                <div className={"d-flex flex-column"}>
